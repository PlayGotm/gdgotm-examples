...
func _on_Wall_clicked(instance):
	instance.filled = !instance.filled
	if instance.filled:
		$Options/Map/Classic.filled = false
...
func _on_Easy_clicked(instance):
	instance.filled = !instance.filled
	if instance.filled:
		$Options/Difficulty/Medium.filled = false
		$Options/Difficulty/Hard.filled = false
...
func _on_Medium_clicked(instance):
	instance.filled = !instance.filled
	if instance.filled:
		$Options/Difficulty/Easy.filled = false
		$Options/Difficulty/Hard.filled = false
...
func _on_SortAge_clicked(instance):
	...
	$Options/Sort/SortDifficulty.filled = false
	fetch.sort_property = "created"
	reset()
...
func _on_SortDifficulty_clicked(instance):
	instance.filled = true
	$Options/Sort/SortAge.filled = false
...
func _on_SortDescending_clicked(instance):
	instance.filled = true
	$Options/Sort/SortAscending.filled = false
	fetch.sort_ascending = false
	reset()
...
func _on_SortAscending_clicked(instance):
	instance.filled = true
	$Options/Sort/SortDescending.filled = false
